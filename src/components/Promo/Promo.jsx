  ...
  return (
    <section className='promo'>
        ...
        <div className='promo__content'>
                ...
                <a className='promo__left-item-link animation-btn' href='https://goo.su/P65u' target='_black'>Узнать больше</a>
        </div>
            <img className='promo_img' src={logo} alt='планета Земля'></img>
        </div>
    </section>
  )
}
